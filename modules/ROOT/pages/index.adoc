...
Permaculture is a new science that unifies forestry, watershed management, agriculture, horticulture, botany, and animal biology to work with Nature. Permaculture can restore soil fertility, replenish water tables, build topsoil, and feed the  diversity of life, human, plant, and animal. Permaculture can green deserts and eliminate world hunger. It is the soul of a quiet revolution that empowers individuals and communities to thrive, with less reliance on money or human governance. Once in motion, it sustains itself.
